...
//         Type::Vectorized(t) => format!("*{}", type_to_ctype(*t)),
//     }
// }
...
//             LValue::Index(v) => format!("*{}", Self::render_expr(v)),
//         }
//     }
...
//                 reg: 0,
//                 ty: Type::Vectorized(Box::new(Type::F16)),
//                 is_const: false,
//             }],
//             body: Block(vec![]),
//         };
...
//                 Instruction::Define(
//                     3,
//                     Expr::Add(Box::new(Expr::Load(1)), Box::new(Expr::Immediate(1.))),
//                 ),
//                 Instruction::Affect(LValue::Index(Box::new(Expr::Load(1))), Expr::Load(3)),
//             ]),
//         };
